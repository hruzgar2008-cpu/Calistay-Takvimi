...
export default function EventDetailPage() {
  ...
  const mergedEvents = useMergedEvents(sampleEvents);

  const event = useMemo(
    () => mergedEvents.find((e) => e.slug === slug),
    [mergedEvents, slug],
  );
      ...
      <main className="flex-1">
        {!event ? (
          <div className="container mx-auto px-4 py-24 text-center">
            <p className="mb-6 text-muted-foreground">Bu etkinlik bulunamadi.</p>
            ...
            <div className="relative h-64 overflow-hidden bg-gradient-to-br from-primary via-primary/80 to-primary/60 md:h-80 lg:h-96">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                <div className="container mx-auto">
                  ...
                  <h1 className="text-balance text-2xl font-bold text-white md:text-4xl lg:text-5xl">
                    {event.title}
                  </h1>
                </div>
              </div>
